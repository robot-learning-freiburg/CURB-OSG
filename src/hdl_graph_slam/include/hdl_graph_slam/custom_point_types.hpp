...
POINT_CLOUD_REGISTER_POINT_STRUCT(hdl_graph_slam::POINT_XYZ_INTENSITY_CLASS_INSTANCE, (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)(float, class_label, class_label)(float, instance, instance))
